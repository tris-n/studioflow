	...
	return (
		<>
			<Stack direction="row" justifyContent="space-between" alignItems="center">
				...
				{/* Text Box */}
				<Box sx={textBoxStyle}>
					<TypeH1>Welcome to <strong>Studio</strong>Flow</TypeH1>
					<TypeP><strong>Studio</strong>Flow helps you manage film projects, monitor production status, identify staffing needs, access deliverables, and streamline your workflow.</TypeP>
				</Box>
